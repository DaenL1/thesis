...
import { GetCurrentMemberData, MemberData, Purchase, ItemDetail } from "../actions"
...
export default function MemberPurchasesPage() {
  ...
  const filteredPurchases = memberData?.purchaseHistory.filter(purchase => {
    ...
    const matchesSearch = 
      ...
      purchase.itemDetails.some(item => 
            ...
            <Card className="bg-gradient-to-br from-amber-50 to-white border-amber-100 shadow-sm hover:shadow-md transition-all">
              <CardContent className="p-6">
                ...
                <div className="text-3xl font-bold text-gray-900">
                  {formatCurrency(memberData.purchaseHistory.reduce((total, purchase) => total + purchase.total, 0))}
                </div>
                    ...
                    <CardContent className="p-0">
                      <div className="p-6">
                        ...
                        <div className="mt-4 space-y-3 bg-gray-50 p-4 rounded-lg">
                          {purchase.itemDetails.slice(0, 3).map((item, idx) => (
