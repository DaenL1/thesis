              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold text-amber-900">₱{memberData.currentCredit.toFixed(2)}</p>
                      </div>
                    </div>
                ...
                <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-none shadow-sm">
                  ...
                  <CardContent className="space-y-3">
                    {memberData.purchaseHistory.slice(0, 2).map((purchase, index) => (
                      <div key={index} className="flex items-center justify-between p-2 bg-white/70 rounded-lg shadow-sm">
                        ...
                        <p className="font-bold text-orange-700">₱{purchase.total.toFixed(2)}</p>
                      </div>
                    ))}
                    
                    <p className="text-xs text-orange-600 text-right pt-1">
                      {memberData.purchaseHistory.length} total transactions
                    </p>
                  </CardContent>
                </Card>

                {/* Member Status Card */}
                <Card className="bg-gradient-to-br from-orange-100 to-orange-200 border-none shadow-sm">
                  <CardHeader className="pb-2">
                    <CardTitle className="flex items-center gap-2 text-orange-800">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-3">
                      <div className="h-12 w-12 rounded-full bg-amber-100 flex items-center justify-center">
                        <Star className="h-6 w-6 text-orange-600 fill-orange-200" />
                      </div>
                      <div>
                        <p className="text-sm font-medium text-orange-800">Active Member</p>
                        <p className="text-xs text-orange-600">In good standing</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/70 rounded-lg p-3 shadow-sm">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-sm font-medium text-orange-800">{formatDate(memberData.joinDate)}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs text-orange-600">Membership ID</span>
                        <span className="text-sm font-medium text-orange-800">{memberData.memberID}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 text-center">
                        ...
                        <p className="text-xl font-bold text-amber-600">
                          ₱{memberData.purchaseHistory.reduce((total, purchase) => total + purchase.total, 0).toFixed(2)}
                        </p>
                      </div>
                      <div className="bg-gray-50 rounded-lg p-4 text-center">
                        <p className="text-gray-500 text-sm mb-1">Average Purchase</p>
                        <p className="text-xl font-bold text-amber-600">
                          ₱{(memberData.purchaseHistory.reduce((total, purchase) => total + purchase.total, 0) / 
                      ...
                      <Card className="bg-gradient-to-br from-green-50 to-green-100 border-none shadow-sm">
                        <CardContent className="p-4">
                          ...
                          <p className="text-2xl font-bold text-green-900">
                            {memberData.purchaseHistory.filter(p => p.status === "Completed").length}
                          </p>
                        </CardContent>
                      </Card>
                  ...
                  <Card className="border border-gray-200 shadow-sm overflow-hidden h-full">
                    ...
                    <CardContent className="p-6">
                      {memberData.upcomingPayments.length > 0 ? (
                        <div className="space-y-4">
                          {memberData.upcomingPayments.map((payment, index) => (
                            <div key={index} className="flex items-center justify-between p-4 border border-amber-100 bg-amber-50/50 rounded-lg shadow-sm">
