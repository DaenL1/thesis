...
import { GetCurrentMemberData, MemberData, Payment } from "../actions"
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{formatCurrency(memberData.currentCredit)}</p>
                  </div>
                </div>
                <Button 
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {memberData.upcomingPayments.length > 0 
                        ? formatCurrency(memberData.upcomingPayments.reduce((sum, payment) => sum + payment.amount, 0))
                        : formatCurrency(0)}
                    </p>
                  </div>
                </div>
                <div className="space-y-2">
                  {memberData.upcomingPayments.length > 0 ? (
                    memberData.upcomingPayments.slice(0, 2).map((payment, idx) => (
                ...
                <CardContent>
                  {memberData.upcomingPayments.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {memberData.upcomingPayments.map((payment, idx) => (
            ...
            <TabsContent value="history" className="space-y-4">
              <Card>
                ...
                <CardContent>
                  ...
                  {memberData.paymentHistory.filter(payment => 
